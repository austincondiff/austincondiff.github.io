...
class HeroContent extends React.PureComponent {
  render() {
    return (
      <div className="hero-content">
        ...
        <p>
          ...
          experiences for small businesses and Fortune 500 companies using the best design techniques and the latest
